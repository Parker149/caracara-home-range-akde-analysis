...
# --- Separate data by fledge dates ---

# F36312 & M36313 === 05/02/11
pre_F36312 <- F36312[F36312$datetime < as.POSIXct("2011-05-02"), ]
post_F36312 <- F36312[F36312$datetime > as.POSIXct("2011-05-02"), ]

pre_M36313 <- M36313[M36313$datetime < as.POSIXct("2011-05-02"), ]
post_M36313 <- M36313[M36313$datetime > as.POSIXct("2011-05-02"), ]

# F44868 & M68230 === 07/12/11
pre_F44868 <- F44868[F44868$datetime < as.POSIXct("2011-07-12"), ]
post_F44868 <- F44868[F44868$datetime > as.POSIXct("2011-07-12"), ] # <-- Only comes out to 2 data points, won't save

pre_M68230 <- M68230[M68230$datetime < as.POSIXct("2011-07-12"), ]
post_M68230 <- M68230[M68230$datetime > as.POSIXct("2011-07-12"), ]

# --- Save pre and post data ---
setwd("/Users/parkerwilkerson/Desktop/EEB_HW/Caracara/data/clean_data/pre_fledge/")
write.csv(pre_F36312,"pre_F36312.csv")
write.csv(pre_M36313,"pre_M36313.csv")
write.csv(pre_F44868,"pre_F44868.csv")
write.csv(pre_M68230,"pre_M68230.csv")

setwd("/Users/parkerwilkerson/Desktop/EEB_HW/Caracara/data/clean_data/post_fledge/")
write.csv(post_F36312,"post_F36312.csv")
write.csv(post_M36313,"post_M36313.csv")
write.csv(post_M68230,"post_M68230.csv")
